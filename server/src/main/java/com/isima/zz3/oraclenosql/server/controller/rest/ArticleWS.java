...
public class ArticleWS {
    ...
    @Path("{id}/keyword")
    @POST
    public RestResponse<ArticleKeyword> addKeywords(@PathParam("id") int idArticle, ArticleKeyword keyword) throws ParseException {
        RestResponse<ArticleKeyword> resp = new RestResponse<>(151, "204");
    ...
    @PUT
    public RestResponse<ArticleKeyword> updateKeywords(@PathParam("id") int idArticle, @PathParam("idKeyword") String keyword, @PathParam("rank") int rank, ArticleKeyword newKeyword) throws ParseException {
        int status = 151;

        if (ldao.exist(idArticle)) {
            ArticleKeyword keyw = kdao.read(keyword, rank);
            if (keyw != null) {
    ...
    @Path("{id}/keyword/{keyword}/{rank}")
    @DELETE
    public RestResponse<ArticleKeyword> deleteKeywords(@PathParam("id") int idArticle, @PathParam("keyword") String keyword, @PathParam("rank") int rank) throws ParseException {
        int status = 151;
