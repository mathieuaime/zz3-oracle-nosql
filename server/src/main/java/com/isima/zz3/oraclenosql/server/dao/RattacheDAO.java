...
public class RattacheDAO {
    ...
    public void genererTest(int n) {
        ...
        for (int i = 0; i < n; i += 2) {
            create(Laboratory.MAJOR_KEY, "Laboratoire" + i, i, 1);
            create(University.MAJOR_KEY, "Universite" + i, i, 1);
        }
    }
    ...
    public void afficherTest(int n) {
        ...
        for (int i = 0; i < n; i++) {
            Rattache a = read(Laboratory.MAJOR_KEY, "Laboratoire" + i, 1);
            System.out.println(a);
            a = read(University.MAJOR_KEY, "Universite" + i, 1);
            System.out.println(a);
        }
    }

    public void supprimerTest(int n) {
        delete(Laboratory.MAJOR_KEY);
        delete(University.MAJOR_KEY);
    }
}
