		...
		readAuteurs: function() {
			...
			return deferred.promise;
                ...
                getAuteurFromArticleTitre:function(titre){
                     var deferred = $q.defer();
                      $http.get('http://localhost:8080/ServerOracleNoSQL/ws/auteur/'+titre+'/articleFromName').then(function successCallback(response) {
				deferred.resolve(response.data);
			}, function errorCallback(response) {
                                deferred.reject('Impossible de créer l\'article');
				deferred.reject(response.data);
          ...
          //Mise à jour de la relation est rattaché : un auteur est rattache à une universite
			...
			return deferred.promise;
              ...
              GetLaboratoiresAuteurFromId:function(id){
                  ...
                  var deferred = $q.defer();
                  $http.get('http://localhost:8080/ServerOracleNoSQL/ws/auteur/'+id+'/laboratoire').then(function successCallback(response) {
				$log.debug('... réponse du serveur : OK.');
				deferred.resolve(response.data);
			}, function errorCallback(response) {
				$log.debug('... réponse du serveur : erreur.');
			...
			return deferred.promise;
              ...
              getKeywordAuteur:function(idAuteur){
                  var deferred = $q.defer();
                  $http.get('http://localhost:8080/ServerOracleNoSQL/ws/auteur/'+idAuteur+'/keywords').then(function successCallback(response) {
				$log.debug('... réponse du serveur : OK.');
				deferred.resolve(response.data);
			}, function errorCallback(response) {
				$log.debug('... réponse du serveur : erreur.');
