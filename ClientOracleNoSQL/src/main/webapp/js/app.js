...
oraclenosql.config(['$routeProvider',
	...
	$routeProvider
		...
		.when('/auteur', { controller: 'auteurMainController', templateUrl: 'partials/auteur.html', view: 'auteur' })
		.when('/laboratoire', { controller:'laboratoireMainController', templateUrl: 'partials/laboratoire.html', view: 'laboratoire' })
		.when('/universite', { controller:'universiteMainController',templateUrl: 'partials/universite.html', view: 'universite' })
