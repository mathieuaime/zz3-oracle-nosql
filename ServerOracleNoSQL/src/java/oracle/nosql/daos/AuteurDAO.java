...
public class AuteurDAO {
    ...
    public Auteur read(int auteurId) {
        ...
        if (vv2 != null) {
            ...
            a = new Auteur(auteurId, bytes2);
        }
        
        return a;        
    }
    
    public List<Auteur> read(){
        Key myKey2 = Key.createKey(Auteur.MAJOR_KEY);
        Iterator<KeyValueVersion> i = store.storeIterator(Direction.UNORDERED, 0, myKey2, null, null);
    ...
    public List<Auteur> getLast(int n){
        Key myKey2 = Key.createKey(Auteur.MAJOR_KEY);
    ...
    public String update(int auteurId, String nom, String prenom, String adresse, String phone) {
    ...
    public String update(int auteurId, Auteur auteur) {
        return update(auteurId, auteur.getNom(), auteur.getPrenom(), auteur.getAdresse(), auteur.getPhone());
    }
